...
var lang = {
  ...
  isArray, isArrayBuffer, isArrayLike, isArrayLikeObject, isBoolean: isBoolean$1,
  isBuffer, isDate, isElement, isEmpty, isEqual,
  isEqualWith, isError, isFinite: isFinite$1, isFunction: isFunction$1, isInteger: isInteger$1,
  isLength, isMap, isMatch, isMatchWith, isNaN: isNaN$1,
  isNative, isNil, isNull: isNull$1, isNumber, isObject: isObject$1,
...
lodash.prototype.at = seq$1.at;
lodash.prototype.chain = seq$1.wrapperChain;
lodash.prototype.commit = seq$1.commit;
lodash.prototype.next = seq$1.next;
lodash.prototype.plant = seq$1.plant;
lodash.prototype.reverse = seq$1.reverse;
lodash.prototype.toJSON = lodash.prototype.valueOf = lodash.prototype.value = seq$1.value;

// Add lazy aliases.
lodash.prototype.first = lodash.prototype.head;

if (symIterator$1) {
  lodash.prototype[symIterator$1] = seq$1.toIterator;
}
        ...
        return (h("picto-styled", null,
            h("table", { class: 'table', style: { width: '100%' } },
                ...
                h("tbody", null, this.menu.components.map((c, index) => {
                    ...
                    return (h("tr", { class: styles$1.row },
                        h("td", null,
                        ...
                        h("td", { class: 'content' },
                            h("ul", null, c.props.map(p => (h("li", null,
                                ...
                                h("code", null, p.type),
                                p.docs && h("div", { class: styles$1.docs }, p.docs)))))),
                        h("td", null,
                            h("div", { class: styles$1.wrapper }, (innerHTML || props) && (h("div", { "no-style": true },
...
class Markdown {
    ...
    render() {
        ...
        return (h("picto-styled", { class: styles$2.main, innerHTML: `<div class='content'>${src}</div>` }));
    }
                ...
                h("aside", { class: 'menu is-size-7' },
                    h("ul", { class: 'menu-list' },
                        h("li", null, this.options.map((opt) => {
                            if (!opt.links) {
                                return (h("p", { class: `menu-label ${styles$3.title}` }, opt.label));
                            }
                            else {
...
export { Graph as PictoGraph, Index as PictoGraphIndex, Markdown as PictoMarkdown, Menu as PictoMenu, Router as StencilRouter };
